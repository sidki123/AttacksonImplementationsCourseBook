::: {#cha:High Data Complexity Power/EM 1 .section .level1 number="7"}
...
![Vaizata method stages](../media/file77.png){#fig:vaizata}
...
-   This Article posted by Stefan Mangard []{.citation
