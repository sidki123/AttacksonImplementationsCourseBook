::: {#c4_forthchapter:cha .section .level1 number="4"}
...
::: {#resistors .section .level3 number="4.1.2"}
...
::: {#buliding-an-amplifier-using-a-fet .section .level3 number="4.2.8"}
...
::: {#measurement-setups .section .level3 number="4.2.19"}
